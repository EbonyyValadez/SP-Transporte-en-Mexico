...
```
Se puede notar que la DAG generada por Hill Climbing se ajusta mejor con base en los puntajes en las pruebas de comparación con la mejor DAG de las 3 propuestas anteriormente.

prueba de Query: Rafa
...
cpquery(bn,
        ...
        evidence = (S == "Hombre" &
                    A %in% c("MedianaEdad","AdultoMayor") &
                    EST == "MedioBajo" &
                    D == "Semana"),
        n = 10^6)
```
...
cpquery(bn, 
        ...
        n = 10^6)
```
Respuesta: sí, los hombres de esas características usan más la moto o automovil entre semana que las mujeres con las mismas características.
