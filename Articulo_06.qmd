...
P(T \in \{\text{Auto},\text{Moto}\} \mid 
S=\text{Mujer},\ D=\text{Semana},\ EST=\text{MedioBajo},\ 
A \in \{\text{MedianaEdad},\text{AdultoMayor}\})
=
\frac{\#\{T \in \{\text{Auto},\text{Moto}\},\ S=\text{Mujer},\ D=\text{Semana},\ EST=\text{MedioBajo},\ A \in \{\text{MedianaEdad},\text{AdultoMayor}\}\}}
{\#\{S=\text{Mujer},\ D=\text{Semana},\ EST=\text{MedioBajo},\ A \in \{\text{MedianaEdad},\text{AdultoMayor}\}\}}.
$$
...
-   $P(H=\mathrm{1homas}\mid L=\mathrm{Loc\_menor2.5k}, T \in \{\dots\}) \approx 0.188$
-   $P(H=\mathrm{1homas}\mid L=\mathrm{Loc\_100k+}, T \in \{\dots\}) \approx 0.203$
