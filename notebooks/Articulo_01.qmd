...
Dado que la base de datos empleada corresponde a una encuesta aplicada en la Zona Metropolitana del Valle de México, se verificó la frecuencia de registros cuya entidad de origen fuera “Aguascalientes” y esta resultó igual a 0. Esto es consistente con el hecho de que las únicas entidades observadas en la variable O (entidad de origen) son “CDMX”, “Hidalgo” y “Edomex”. En consecuencia, dentro de esta base, la probabilidad condicional de que una persona de estrato “MedioBajo” resida en Aguascalientes dado que se desplaza en taxi es 0, es decir:
