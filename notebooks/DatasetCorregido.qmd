...
Revisamos los cantidad de filas con el valor "99" ya que éste es un código dentro de la INEGI para decir que ese dato se perdió o no se especificó, si son menos del 5% de los datos cambiaremos esos valores por nan para luego eliminarlos.
```{r}
